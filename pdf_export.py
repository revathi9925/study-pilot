...
# ── Color Palette ──────────────────────────────────────────
RED_BG      = colors.HexColor('#FFE2E2')
RED_ACCENT  = colors.HexColor('#DC2626')
YEL_BG      = colors.HexColor('#FFF9C3')
...
TEXT_DARK   = colors.HexColor('#1F293B')
...
def generate_pdf(rows, summary="", output_path="timetable.pdf"):
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=MARGIN, bottomMargin=MARGIN,title="studypilot - weekly Timetable",
    )
